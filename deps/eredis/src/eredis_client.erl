...
%% API
-export([start_link/6, stop/1, select_database/2, start_connect/1]).
...
-spec start_connect(Options::list()) -> Pid::pid() | {error, Reason::term()}.
start_connect(Options) ->
    eredis_conn_sup:new_conn(Options).
